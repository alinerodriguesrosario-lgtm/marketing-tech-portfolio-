...
```mermaid
flowchart TD
    A["/sobre-nos<br/>Página institucional"] --> B["/central-de-confianca<br/>Segurança, privacidade e governança"]
    A --> C["/cases<br/>Provas sociais e clientes"]
    D["/help-desk-whatsapp<br/>Página comercial e SEO"] --> C
    D --> G["/precos<br/>Planos e conversão"]
    D --> H["/comparativos<br/>Apoio à decisão"]
    D --> I["/recursos<br/>Funcionalidades e módulos"]
    B --> C
    I --> G
    H --> G
    C --> E["/cases/cyrela<br/>Case individual"]
    C --> F["/cases/umbrella<br/>Case individual ou ebook"]
```
